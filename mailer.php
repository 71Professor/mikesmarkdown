...
<body style="font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
        <h1 style="color: white; margin: 0; font-size: 24px;">✉️ E-Mail-Adresse bestätigen</h1>
    </div>
    ...
    <div style="background: #f8f9fa; padding: 30px; border-radius: 0 0 10px 10px;">
        ...
        <p style="font-size: 16px; margin-bottom: 20px;">
            Willkommen bei MikesMarkdown! Wir freuen uns, Sie an Bord zu haben.
        </p>
        ...
        <p style="font-size: 14px; color: #6c757d; margin-bottom: 10px;">
            Falls Sie diese Registrierung nicht vorgenommen haben, können Sie diese E-Mail ignorieren.
        </p>

        <p style="font-size: 12px; color: #adb5bd; margin-top: 30px; padding-top: 20px; border-top: 1px solid #dee2e6;">
            Falls der Button nicht funktioniert, kopieren Sie diesen Link in Ihren Browser:<br>
            <a href="' . htmlspecialchars($verifyLink) . '" style="color: #667eea; word-break: break-all;">' . htmlspecialchars($verifyLink) . '</a>
        </p>
    ...
    <div style="text-align: center; margin-top: 20px; padding: 20px; color: #adb5bd; font-size: 12px;">
        ...
        // Plain-Text-Alternative für E-Mail-Clients ohne HTML
        $mail->AltBody = "E-Mail-Adresse bestätigen\n\n" .
                        "Hallo,\n\n" .
                        "Willkommen bei MikesMarkdown! Wir freuen uns, Sie an Bord zu haben.\n\n" .
                        "Um Ihre Registrierung abzuschließen, bestätigen Sie bitte Ihre E-Mail-Adresse:\n" .
                        $verifyLink . "\n\n" .
